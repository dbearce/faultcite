...
FaultCite is a controlled-pilot CNC repair workflow for machine-down intake,
private evidence, technician observations, manager cause confirmation, restart
...
Use [`docs/PILOT_READINESS.md`](docs/PILOT_READINESS.md) as the release packet
and two-account acceptance script. Do not approve a pilot gate without dated
evidence and a named owner.

Pilot users can save structured feedback and support requests from Help &
Safety. These records support weekly review; they are not emergency alerts and
do not replace the customer's normal safety escalation process.
