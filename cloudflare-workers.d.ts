declare module "cloudflare:workers" {
  export const env: {
    ...
    FAULTCITE_MIGRATION_EXPORT_ENABLED?: string;
    FAULTCITE_MIGRATION_EXPORT_EXPIRES_AT?: string;
    FAULTCITE_MIGRATION_EXPORT_SUBJECT?: string;
    FAULTCITE_MIGRATION_SOURCE_FROZEN?: string;
